...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
            ...
            ->end()
            ->scalarNode('sp_org_name')->isRequired()->cannotBeEmpty()->defaultValue('%spid_symfony.sp_org_name%')->end()
            ->scalarNode('sp_org_display_name')->isRequired()->cannotBeEmpty()->defaultValue('%spid_symfony.sp_org_display_name%')->end()
            ->scalarNode('sp_contact_ipa_code')->isRequired()->cannotBeEmpty()->defaultValue('%spid_symfony.sp_contact_ipa_code%')->end()
            ->scalarNode('sp_contact_email')->isRequired()->cannotBeEmpty()->defaultValue('%spid_symfony.sp_contact_email%')->end()
            ->scalarNode('sp_contact_phone')->isRequired()->cannotBeEmpty()->defaultValue('%spid_symfony.sp_contact_phone%')->end()
